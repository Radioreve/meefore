	...
	var print = require('../../services/print')( __dirname.replace( process.cwd()+'/', '' ) + '/validate-pusher-auth.js' );
	...
	function checkWithDatabase( req, callback ){
		...
		print.debug( req, 'Checking user has permission to subscribe to this channel');
