	...
	LJ.text_source = _.merge( LJ.text_source || {}, {
		...
		intro_welcome_subheader: {
			"fr": "Vous aimez sortir et rencontrer de nouvelles personnes? Meefore va révolutionner vos soirées. Suivez le tour pour découvrir comment.",
			"en": "You love partying and meeting new people? Meefore will change your nights. Discover how with the tour."
		},
		intro_welcome_btn: {
			"fr": "Montrez-moi",
			"en": "Show me"
		...
		intro_text_2: {
			"fr": "Chaque utilisateur peut proposer un meefore...",
			"en": "Each user can host a meefore..."
		},
		intro_text_3: {
		...
		intro_text_5: {
			...
			"en": "This, is what happens when multiple groups host meefore before going to the same party afterwards"
		},
		intro_text_6: {
		...
		intro_text_7: {
			"fr": "Ici, c'est les organisateurs du meefore",
			"en": "Here, are the people that host the meefore"
		},
		intro_text_8: {
			"fr": "Là, c'est la soirée où ils ont prévu d'aller après leur meefore",
			"en": "This, is the party where they are headed after their meefore"
		},
		intro_text_9: {
			"fr": "Ici, vous pouvez demander à rejoindre leur meefore",
			"en": "This is where you ask to join their meefore"
		},
		intro_text_10: {
		...
		intro_text_11: {
			"fr": "Meefore encourage la rencontre en groupes, c'est pourquoi vous devez être au moins deux pour rejoindre un meefore",
		...
		lp_key_people_text: {
			...
			"en": "Spot the pregame parties going to the same party as yours and send a participation request. No pregame scheduled yet? "
				  + "Create yours!"
		},
		lp_key_party_text: {
		...
		lp_map_button: {
			...
			"en": "See all <span>before</span> the meefore"
		},
		lp_footer_followus: {
			"fr": "Nous suivre",
			"en": "Follow us"
		...
		lp_loading_party: {
			...
			"en": "Loading next pregaming parties..."
		}
